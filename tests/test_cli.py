...
from azure_sub_migrator.cli import cli
...
class TestCLI:
    def test_help(self):
        ...
        assert "Azure Sub Migrator" in result.output
    ...
    @patch("azure_sub_migrator.cli.get_credential")
    ...
    @patch("azure_sub_migrator.cli.get_credential", side_effect=Exception("no creds"))
    ...
    @patch("azure_sub_migrator.scanner.list_subscriptions")
    @patch("azure_sub_migrator.cli.get_credential")
