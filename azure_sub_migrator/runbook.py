    ...
    "Microsoft.Authorization/roleAssignments": {
        ...
        "post": [
            (
                ...
                "# then use the azure-sub-migrator import-rbac command:\n"
                "# azure-sub-migrator import-rbac -s {sub} -f rbac_assignments_{sub_short}.json -m principal_mapping.json",
            ),
        ],
    },
...
def generate_runbook(
    ...
    ln("")
    ln(f"Generated by **Azure Sub Migrator** on {now}")
    ln("")
    ln("---")
    ln("")
